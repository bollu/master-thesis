...
\begin{itemize}
\item Parallel transport: given a base word and an analogy, find a word with the analogy we are interested in
\item Geodesic computation: given two words, represent the analogy between the words.
\end{itemize}
