...
\begin{itemize}
\item [Function words are words which are largely syntactic rather than semantic. Thus their meaning is 'maximally fuzzy'. \pause
...
\item The non-function words have been emphasized for comparison.
\end{frame}
