...
vector representations. \todo{citations of some eval papers. Some further
  sophistry needed here.}
...
set representations in \autoref{chapter:abstract-interpretation}. \todo{is the
  building happening in abstract interpretation or the fuzzy set chapter?}
...
gradient descent. Rather, a style of perceptron-based update is used.
\todo{perceptron-based \textit{batch} update?}
Thus,
...
hopelessly non-computable. In parallel, we consider an abstract world, one that
is but a mere approximation to the concrete. \todo{For the love of God, explain
  what concrete and abstract meanings are BEFORE you go into the computability
  detailing. I'd suggest starting with the example and then go towards the
  definition.}
This loss of information allows
...
fuzzy sets. \todo{needs polishing}
