...
correctness is based on the distributional hypothesis. \todo{citations on both
word2vec and correctness} The \texttt{word2vec} algorithm uses a shallow neural
...
is as successful as it is. \todo{citation} In comparison to LSA, which has
